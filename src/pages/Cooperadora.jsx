      ...
      <div className="px-8 h-1/2 flex justify-between gap-8">
        <div className="border shadow-lg shadow-customSoft-blue p-2 rounded-lg w-1/2 bg-white">
          <p className="font-poppins">
            ...
            0140032801503305438550 CUIT: 30-71753985-7 IMPORTANTE: Por favor,
            luego de realizar la transferencia enviar el comprobante mediante
            WhatsApp al 221-319-2360. Muchas gracias!!!
          </p>
        </div>
